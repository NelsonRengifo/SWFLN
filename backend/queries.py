...
def event_roster(db, offset, start_date, end_date, attended) -> list[dict]:
...
def get_roster_count(db, start_date, end_date, attended) -> int:
    ...
    sql = load_sql("get_roster_count", "admin")
